...
library PolicyLib {
    ...
    // So 1 USDC = 1_000_000, 0.01 USDC = 10_000
        uint256 internal constant MAX_ALLOWED_PAYEES = 20;
    ...
    struct Policy {
        ...
        bool    exists;               // to distinguish "no policy" vs "policy with 0 limits"
  ...
  function isPayeeAllowed(
        ...
        // Safe — capped at MAX_ALLOWED_PAYEES in setPolicy
